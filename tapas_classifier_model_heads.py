...
class TapasForQuestionAnswering(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.aggregation_selector = nn.Linear(config.hidden_size, config.num_aggregation_labels)
        self.cell_selector = nn.Linear(config.hidden_size, config.num_classification_labels)
